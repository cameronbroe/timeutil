...
func TestStrftime(t *testing.T) {
	date := time.Date(2005, 2, 3, 4, 5, 6, 1007000, time.UTC)
	AssertEqual(t, Strftime(&date,
		"%a %A %w %d %b %B %m %y %Y %H %I %p %M %S %s %f %z %Z %j %U %W %c %x %X %%"),
		"Thu Thursday 4 03 Feb February 02 05 2005 04 04 AM 05 06 001 001007 +0000 UTC 034 05 05 Thu Feb 3 04:05:06 2005 02/03/05 04:05:06 %")
